package com.example.wb_5_3.data.network

import android.util.Log
import com.example.wb_5_3.data.model.CatFavoriteAnswer
import com.example.wb_5_3.data.model.CatFavoriteModelData
import com.example.wb_5_3.data.model.CatFavoriteRequest
import com.example.wb_5_3.data.model.CatModelData
import com.example.wb_5_3.data.network.Environment.API_KEY
import com.example.wb_5_3.data.network.Environment.API_KEY_LABEL
import com.example.wb_5_3.data.network.Environment.BASE_API
import com.example.wb_5_3.data.network.Environment.GET_RANDOM_CAT_QUERY
import com.example.wb_5_3.data.network.Environment.FAVOURITE_CAT_QUERY
import com.example.wb_5_3.data.toCatModelDomain
import com.example.wb_5_3.data.toDomain
...
class CatApiHelper @Inject constructor(private val client: HttpClient){
    ...
    suspend fun getFavoriteCats(): List<CatModelDomain>{
        ...
        return cats.map { it.toCatModelDomain() }
    }
